...
public class LoginButton extends View {
    ...
    private void init() {
        ...
        paint2 = new Paint();
        paint2.setColor(getResources().getColor(R.color.black,null));
        paint2.setStyle(FILL);

        loginPaint = new Paint();
        loginPaint.setColor(ContextCompat.getColor(getContext(), R.color.black));
        loginPaint.setTextAlign(CENTER);
        //loginPaint.setShadowLayer(1.5f, -1, 1, Color.LTGRAY);
        loginPaint.setTextSize(dpToPixels(16));

        orPaint = new Paint();
        orPaint.setColor(ContextCompat.getColor(getContext(), R.color.gray));
